...
//    过滤1-9中的偶数
    ...
    /*4 按照单词的长度升序排列*/
    "spark is most exciting thing happening in big data today"
      .split(" ")
...
//    8(x:Double)才是真正执行所要传入的参数值
    ...
    val fun2 = 3 * (_:Double)
    val funn3:Double => Double = 3 * _// _为返回类型 Double =》 Double中参数类型
